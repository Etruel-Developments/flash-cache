...
/** * Deactivate Flash Cache on Deactivate Plugin  */
register_deactivation_hook( plugin_basename( FLASH_CACHE_PLUGIN_FILE ), 'flash_cache_deactivate' );
function flash_cache_deactivate() {
		
	/**
	 * Delete all the cache files (same of the Delete cache button).
	 * Also should delete all Flash-Cache modifications to .htaccess 
	 */
