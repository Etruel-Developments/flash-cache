<?php
if ( ! function_exists('flash_cache_get_advanced_settings') ):
...
if ( ! function_exists('flash_cache_get_general_settings') ):
...
if ( ! function_exists('flash_cache_admin_bar_render') ):
...
if ( ! function_exists('flash_cache_delete_action') ):
...
if ( ! function_exists('flash_cache_delete_cache_from_url') ):
...
if ( ! function_exists('flash_cache_default_query') ):
...
if ( ! function_exists('flash_cache_get_content') ):
...
if ( ! function_exists('flash_cache_get_nginx_conf_info') ):
...
if ( ! function_exists('flash_cache_get_htaccess_info') ):
...
if ( ! function_exists('flash_cache_seconds_2_time') ):
...
if ( ! function_exists('flash_cache_get_logged_in_cookie') ):
...
if ( ! function_exists('flash_cache_update_htaccess') ):
...
if ( ! function_exists('flash_cache_remove_rules') ):
...
if ( ! function_exists('flash_cache_remove_marker') ):
...
if ( ! function_exists('flash_cache_is_writeable_ACLSafe') ):
...
if ( ! function_exists('flash_cache_get_current_url') ):
...
if ( ! function_exists('flash_cache_get_home_path') ):
...
if ( ! function_exists('flash_cache_get_content_to_php') ):
...
if ( ! function_exists('flash_cache_get_var_javascript') ):
...
if ( ! function_exists('flash_cache_delete_dir') ):
...
if ( ! function_exists('flash_cache_delete_cache_files') ):
...
if ( ! function_exists('flash_cache_get_path') ):
...
if ( ! function_exists('flash_cache_increment_disk_usage') ):
...
if ( ! function_exists('flash_cache_decrement_disk_usage') ):
...
if ( ! function_exists('flash_cache_settings_icons') ):
...
if ( ! function_exists('flash_cache_get_menus') ):
